...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	{
		...
		playgroundRouter.POST("/video/generations", middleware.ModelRequestRateLimit(), controller.VideoGeneration)
		playgroundRouter.GET("/video/generations/:task_id", controller.VideoGenerationFetch)
	}
